...
- **🛰️ Monitoreo / control de respuestas · NASync DX2800**: registra en memoria una bitácora de eventos y un snapshot del equipo; permite **sincronizar con el NAS** (WebDAV PUT / webhook POST) o **descargar JSON** para subirlo a su carpeta compartida. El receptor y el **tablero del docente** que consolida a todos los equipos están en [`nas-receiver/`](nas-receiver/) (Node sin dependencias + Docker para el NASync DX2800).
