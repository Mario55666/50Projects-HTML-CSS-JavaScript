...
- **Simulador paradigmático** — cambia color, tipografía y encuadre y observa cómo se desplaza la connotación.
- **Secuencia (Simon)** — memoriza el orden del análisis semiótico.
- **Tablero / carrera** — avanza respondiendo preguntas por categoría.
- **Ficha de análisis** — exporta **PDF** (impresión), **Markdown (.md)** y envío por **correo** al equipo.
...
Instituto de Diseño y Comunicación — Unidad didáctica: Investigación e Innovación Tecnológica
